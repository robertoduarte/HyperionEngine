...
public:
    ...
    static inline consteval auto ThisAbs(const float& value)
    {
        return value > 0 ? value : -value;
    }

    static inline consteval Fxp TestAtan2(const double& x, const double& y)
    {
        // Determine the initial result based on the signs of x and y
        int32_t result = x < 0.0 ? (y < 0.0 ? pi : -pi) : 0;
        ...
        {
            divResult = Fxp(x / y).value;
            result += divResult < 0.0 ? -halfPi : halfPi;
        }
        else
        {
            divResult = -Fxp(y / x).value;
        }
...
static inline constexpr auto val3 = Trigonometry::TestAtan2(10.0, 1.0).ToFloat() * 360.0;
static inline constexpr auto val4 = Trigonometry::TestAtan2(1.0, 10.0).ToFloat() * 360.0;
static inline constexpr auto val5 = Trigonometry::TestAtan2(-10.0, 1.0).ToFloat() * 360.0;
static inline constexpr auto val6 = Trigonometry::TestAtan2(-1.0, 10.0).ToFloat() * 360.0;
static inline constexpr auto val7 = Trigonometry::TestAtan2(10.0, -1.0).ToFloat() * 360.0;
static inline constexpr auto val8 = Trigonometry::TestAtan2(1.0, -10.0).ToFloat() * 360.0;

static inline constexpr auto val9 = Trigonometry::TestAtan2(1.0, 1.0).ToFloat() * 360.0;
static inline constexpr auto val11 = Trigonometry::TestAtan2(-1.0, 1.0).ToFloat() * 360.0;
static inline constexpr auto val13 = Trigonometry::TestAtan2(1.0, -1.0).ToFloat() * 360.0;

static inline constexpr auto val15 = Trigonometry::Tan(0.12).ToFloat();


static inline constexpr auto val16 = Trigonometry::Sin(54.126).ToFloat();
static inline constexpr auto val17 = Trigonometry::Cos(54.126).ToFloat();

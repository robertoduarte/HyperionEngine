/**
 * WARNING, HACKED STL HEADER!!!
 * This is a hacked version of type_traits from
 * the Standard Template Library.
 * This may seem nonsene but we´re using a trimmed
 * version of gcc that does not have these headers.
 *  */
